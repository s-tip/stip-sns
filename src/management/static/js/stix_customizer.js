$(function(){
  ...
  const OPRATION_TYPE_ADD_NODE = 'add_node'
  const OPRATION_TYPE_EDIT_NODE = 'edit_node'
  ...
  function addNode(data, callback) {
    ...
    document.getElementById('add-node-saveButton').onclick = saveNodeData.bind(
      this,
      OPRATION_TYPE_ADD_NODE,
      data,
      callback
    )
    document.getElementById('add-node-cancelButton').onclick =
      clearNodePopUp.bind(this, OPRATION_TYPE_ADD_NODE, callback)
  ...
  function clearNodePopUp(operation_type) {
    if(operation_type == OPRATION_TYPE_ADD_NODE){
  ...
  function cancelNodeEdit(callback) {
    clearNodePopUp(OPRATION_TYPE_EDIT_NODE)
    callback(null)
  }
