...
urlpatterns = [
    ...
    url(r'^settings/get_2fa_secret/$', core_views.get_2fa_secret, name='get_2fa_secret'),
    url(r'^settings/enable_2fa/$', core_views.enable_2fa, name='enable_2fa'),
    url(r'^settings/disable_2fa/$', core_views.disable_2fa, name='disable_2fa'),
